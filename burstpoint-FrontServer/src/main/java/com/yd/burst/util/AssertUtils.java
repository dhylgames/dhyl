...
public abstract class AssertUtils {
    ...
    public static void notEmpty(
            @SuppressWarnings("rawtypes") Collection collection, String message) {
     ...
     */
    public static void isInstanceOf(@SuppressWarnings("rawtypes") Class type,
     ...
     * @see Class#isInstance
     */
    public static void isInstanceOf(@SuppressWarnings("rawtypes") Class clazz,
                                    Object obj) {
        isInstanceOf(clazz, obj, "");
    }

    public static void isInstanceOf(@SuppressWarnings("rawtypes") Class type,
                                    Object obj, RuntimeException throwIfAssertFail) {
        notNull(type, "Type to check against must not be null");
        if (!type.isInstance(obj)) {
            throw throwIfAssertFail;
        }
    ...
    public static void isAssignable(
            @SuppressWarnings("rawtypes") Class superType,
            @SuppressWarnings("rawtypes") Class subType, String message) {
    ...
    public static void isAssignable(
            @SuppressWarnings("rawtypes") Class superType,
            @SuppressWarnings("rawtypes") Class subType) {
